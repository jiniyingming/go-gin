...
func GetFactorySuggestPriceTableName(key ...interface{}) (string, error) {
	tableName, err := components.M.GetTable(components.E.Opts.DBConfig.Name, "factory_suggest_price", key...)
	if err != nil {
		return "", err
	}
...
func (fsp *FactorySuggestPrice) Insert(ctx context.Context, key ...interface{}) error {
	...
	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, fsp.Fid, fsp.Gcid, fsp.Gid, fsp.PlusPercent, fsp.AbsPlusPrice, fsp.CreatedAt, fsp.UpdatedAt, fsp.BrandID)))
	if err != nil {
		return err
	}
	if tx != nil {
		res, err = tx.Exec(sqlstr, fsp.Fid, fsp.Gcid, fsp.Gid, fsp.PlusPercent, fsp.AbsPlusPrice, fsp.CreatedAt, fsp.UpdatedAt, fsp.BrandID)
	} else {
		res, err = dbConn.Exec(sqlstr, fsp.Fid, fsp.Gcid, fsp.Gid, fsp.PlusPercent, fsp.AbsPlusPrice, fsp.CreatedAt, fsp.UpdatedAt, fsp.BrandID)
	}
...
func (fsp *FactorySuggestPrice) Update(ctx context.Context, key ...interface{}) error {
	...
	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, fsp.Fid, fsp.Gcid, fsp.Gid, fsp.PlusPercent, fsp.AbsPlusPrice, fsp.CreatedAt, fsp.UpdatedAt, fsp.BrandID, fsp.ID)))
	if tx != nil {
		_, err = tx.Exec(sqlstr, fsp.Fid, fsp.Gcid, fsp.Gid, fsp.PlusPercent, fsp.AbsPlusPrice, fsp.CreatedAt, fsp.UpdatedAt, fsp.BrandID, fsp.ID)
	} else {
		_, err = dbConn.Exec(sqlstr, fsp.Fid, fsp.Gcid, fsp.Gid, fsp.PlusPercent, fsp.AbsPlusPrice, fsp.CreatedAt, fsp.UpdatedAt, fsp.BrandID, fsp.ID)
	}
	return err
}
...
func FactorySuggestPricesByFid(ctx context.Context, fid int, key ...interface{}) ([]*FactorySuggestPrice, error) {
	...
	for queryData.Next() {
		...
		// scan
		err = queryData.Scan(&fsp.ID, &fsp.Fid, &fsp.Gcid, &fsp.Gid, &fsp.PlusPercent, &fsp.AbsPlusPrice, &fsp.CreatedAt, &fsp.UpdatedAt, &fsp.BrandID)
		if err != nil {
			return nil, err
		}
...
func FactorySuggestPriceByID(ctx context.Context, id uint64, key ...interface{}) (*FactorySuggestPrice, error) {
	...
	if tx != nil {
		err = tx.QueryRow(sqlstr, id).Scan(&fsp.ID, &fsp.Fid, &fsp.Gcid, &fsp.Gid, &fsp.PlusPercent, &fsp.AbsPlusPrice, &fsp.CreatedAt, &fsp.UpdatedAt, &fsp.BrandID)
		if err != nil {
			return nil, err
		}
	} else {
		err = dbConn.QueryRow(sqlstr, id).Scan(&fsp.ID, &fsp.Fid, &fsp.Gcid, &fsp.Gid, &fsp.PlusPercent, &fsp.AbsPlusPrice, &fsp.CreatedAt, &fsp.UpdatedAt, &fsp.BrandID)
		if err != nil {
			return nil, err
		}
	}
