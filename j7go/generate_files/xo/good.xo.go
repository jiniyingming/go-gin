...
type Good struct {
	...
	GcidFirst                 uint           `json:"gcid_first"`                   // gcid_first
	...
	CommissionPrice           float64        `json:"commission_price"`             // commission_price
	Code                      int            `json:"code"`                         // code
	RecomputeProfit           int8           `json:"recompute_profit"`             // recompute_profit
	RecomputeSaleplan         int8           `json:"recompute_saleplan"`           // recompute_saleplan
	SellPrice                 float64        `json:"sell_price"`                   // sell_price
	YSoldNum                  sql.NullInt64  `json:"y_sold_num"`                   // y_sold_num
...
func GetGoodTableName(key ...interface{}) (string, error) {
	tableName, err := components.M.GetTable(components.E.Opts.DBConfig.Name, "goods", key...)
	if err != nil {
		return "", err
	}
...
func (g *Good) Insert(ctx context.Context, key ...interface{}) error {
	...
	sqlstr := `INSERT INTO ` + tableName +
		` (` +
		`pid, title, attribute_good_title, fid, fgid, sid, fbid, gcid, gcid_first, fcid, status, status_change_last_timestamp, factory_only, price_mode, price, plan_id, plan_id_status, plan_next_id, plan_next_time, plan_next_price, plan_next_id_status, prepay_price, can_cod, has_invoice, subtitle, content, packinfo, weight, volume, sku, product_code, bar_code, stock, stockday, unit, sold_num, list_pic_path, list_pic_picids, created, updated, plan_up_timestamp, plan_down_timestamp, seo_keyword, seo_description, fwid, ship_id, is_check, image_mode, market_price, other_image_path, brand_tp_id, pack_tp_id, delegation_tp_id, service_tp_id, report_tp_id, custom_content, visited, goods_comment_num, category_global_path_ids, attribute_value_ids, help_map, brand_id, profit_price, commission_price, code, recompute_profit, recompute_saleplan, sell_price, y_sold_num` +
		`) VALUES (` +
		`?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?` +
		`)`

	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, g.Pid, g.Title, g.AttributeGoodTitle, g.Fid, g.Fgid, g.Sid, g.Fbid, g.Gcid, g.GcidFirst, g.Fcid, g.Status, g.StatusChangeLastTimestamp, g.FactoryOnly, g.PriceMode, g.Price, g.PlanID, g.PlanIDStatus, g.PlanNextID, g.PlanNextTime, g.PlanNextPrice, g.PlanNextIDStatus, g.PrepayPrice, g.CanCod, g.HasInvoice, g.Subtitle, g.Content, g.Packinfo, g.Weight, g.Volume, g.Sku, g.ProductCode, g.BarCode, g.Stock, g.Stockday, g.Unit, g.SoldNum, g.ListPicPath, g.ListPicPicids, g.Created, g.Updated, g.PlanUpTimestamp, g.PlanDownTimestamp, g.SeoKeyword, g.SeoDescription, g.Fwid, g.ShipID, g.IsCheck, g.ImageMode, g.MarketPrice, g.OtherImagePath, g.BrandTpID, g.PackTpID, g.DelegationTpID, g.ServiceTpID, g.ReportTpID, g.CustomContent, g.Visited, g.GoodsCommentNum, g.CategoryGlobalPathIds, g.AttributeValueIds, g.HelpMap, g.BrandID, g.ProfitPrice, g.CommissionPrice, g.Code, g.RecomputeProfit, g.RecomputeSaleplan, g.SellPrice, g.YSoldNum)))
	if err != nil {
		return err
	}
	if tx != nil {
		res, err = tx.Exec(sqlstr, g.Pid, g.Title, g.AttributeGoodTitle, g.Fid, g.Fgid, g.Sid, g.Fbid, g.Gcid, g.GcidFirst, g.Fcid, g.Status, g.StatusChangeLastTimestamp, g.FactoryOnly, g.PriceMode, g.Price, g.PlanID, g.PlanIDStatus, g.PlanNextID, g.PlanNextTime, g.PlanNextPrice, g.PlanNextIDStatus, g.PrepayPrice, g.CanCod, g.HasInvoice, g.Subtitle, g.Content, g.Packinfo, g.Weight, g.Volume, g.Sku, g.ProductCode, g.BarCode, g.Stock, g.Stockday, g.Unit, g.SoldNum, g.ListPicPath, g.ListPicPicids, g.Created, g.Updated, g.PlanUpTimestamp, g.PlanDownTimestamp, g.SeoKeyword, g.SeoDescription, g.Fwid, g.ShipID, g.IsCheck, g.ImageMode, g.MarketPrice, g.OtherImagePath, g.BrandTpID, g.PackTpID, g.DelegationTpID, g.ServiceTpID, g.ReportTpID, g.CustomContent, g.Visited, g.GoodsCommentNum, g.CategoryGlobalPathIds, g.AttributeValueIds, g.HelpMap, g.BrandID, g.ProfitPrice, g.CommissionPrice, g.Code, g.RecomputeProfit, g.RecomputeSaleplan, g.SellPrice, g.YSoldNum)
	} else {
		res, err = dbConn.Exec(sqlstr, g.Pid, g.Title, g.AttributeGoodTitle, g.Fid, g.Fgid, g.Sid, g.Fbid, g.Gcid, g.GcidFirst, g.Fcid, g.Status, g.StatusChangeLastTimestamp, g.FactoryOnly, g.PriceMode, g.Price, g.PlanID, g.PlanIDStatus, g.PlanNextID, g.PlanNextTime, g.PlanNextPrice, g.PlanNextIDStatus, g.PrepayPrice, g.CanCod, g.HasInvoice, g.Subtitle, g.Content, g.Packinfo, g.Weight, g.Volume, g.Sku, g.ProductCode, g.BarCode, g.Stock, g.Stockday, g.Unit, g.SoldNum, g.ListPicPath, g.ListPicPicids, g.Created, g.Updated, g.PlanUpTimestamp, g.PlanDownTimestamp, g.SeoKeyword, g.SeoDescription, g.Fwid, g.ShipID, g.IsCheck, g.ImageMode, g.MarketPrice, g.OtherImagePath, g.BrandTpID, g.PackTpID, g.DelegationTpID, g.ServiceTpID, g.ReportTpID, g.CustomContent, g.Visited, g.GoodsCommentNum, g.CategoryGlobalPathIds, g.AttributeValueIds, g.HelpMap, g.BrandID, g.ProfitPrice, g.CommissionPrice, g.Code, g.RecomputeProfit, g.RecomputeSaleplan, g.SellPrice, g.YSoldNum)
	}
...
func (g *Good) Update(ctx context.Context, key ...interface{}) error {
	...
	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, g.Pid, g.Title, g.AttributeGoodTitle, g.Fid, g.Fgid, g.Sid, g.Fbid, g.Gcid, g.GcidFirst, g.Fcid, g.Status, g.StatusChangeLastTimestamp, g.FactoryOnly, g.PriceMode, g.Price, g.PlanID, g.PlanIDStatus, g.PlanNextID, g.PlanNextTime, g.PlanNextPrice, g.PlanNextIDStatus, g.PrepayPrice, g.CanCod, g.HasInvoice, g.Subtitle, g.Content, g.Packinfo, g.Weight, g.Volume, g.Sku, g.ProductCode, g.BarCode, g.Stock, g.Stockday, g.Unit, g.SoldNum, g.ListPicPath, g.ListPicPicids, g.Created, g.Updated, g.PlanUpTimestamp, g.PlanDownTimestamp, g.SeoKeyword, g.SeoDescription, g.Fwid, g.ShipID, g.IsCheck, g.ImageMode, g.MarketPrice, g.OtherImagePath, g.BrandTpID, g.PackTpID, g.DelegationTpID, g.ServiceTpID, g.ReportTpID, g.CustomContent, g.Visited, g.GoodsCommentNum, g.CategoryGlobalPathIds, g.AttributeValueIds, g.HelpMap, g.BrandID, g.ProfitPrice, g.CommissionPrice, g.Code, g.RecomputeProfit, g.RecomputeSaleplan, g.SellPrice, g.YSoldNum, g.Gid)))
	if tx != nil {
		_, err = tx.Exec(sqlstr, g.Pid, g.Title, g.AttributeGoodTitle, g.Fid, g.Fgid, g.Sid, g.Fbid, g.Gcid, g.GcidFirst, g.Fcid, g.Status, g.StatusChangeLastTimestamp, g.FactoryOnly, g.PriceMode, g.Price, g.PlanID, g.PlanIDStatus, g.PlanNextID, g.PlanNextTime, g.PlanNextPrice, g.PlanNextIDStatus, g.PrepayPrice, g.CanCod, g.HasInvoice, g.Subtitle, g.Content, g.Packinfo, g.Weight, g.Volume, g.Sku, g.ProductCode, g.BarCode, g.Stock, g.Stockday, g.Unit, g.SoldNum, g.ListPicPath, g.ListPicPicids, g.Created, g.Updated, g.PlanUpTimestamp, g.PlanDownTimestamp, g.SeoKeyword, g.SeoDescription, g.Fwid, g.ShipID, g.IsCheck, g.ImageMode, g.MarketPrice, g.OtherImagePath, g.BrandTpID, g.PackTpID, g.DelegationTpID, g.ServiceTpID, g.ReportTpID, g.CustomContent, g.Visited, g.GoodsCommentNum, g.CategoryGlobalPathIds, g.AttributeValueIds, g.HelpMap, g.BrandID, g.ProfitPrice, g.CommissionPrice, g.Code, g.RecomputeProfit, g.RecomputeSaleplan, g.SellPrice, g.YSoldNum, g.Gid)
	} else {
		_, err = dbConn.Exec(sqlstr, g.Pid, g.Title, g.AttributeGoodTitle, g.Fid, g.Fgid, g.Sid, g.Fbid, g.Gcid, g.GcidFirst, g.Fcid, g.Status, g.StatusChangeLastTimestamp, g.FactoryOnly, g.PriceMode, g.Price, g.PlanID, g.PlanIDStatus, g.PlanNextID, g.PlanNextTime, g.PlanNextPrice, g.PlanNextIDStatus, g.PrepayPrice, g.CanCod, g.HasInvoice, g.Subtitle, g.Content, g.Packinfo, g.Weight, g.Volume, g.Sku, g.ProductCode, g.BarCode, g.Stock, g.Stockday, g.Unit, g.SoldNum, g.ListPicPath, g.ListPicPicids, g.Created, g.Updated, g.PlanUpTimestamp, g.PlanDownTimestamp, g.SeoKeyword, g.SeoDescription, g.Fwid, g.ShipID, g.IsCheck, g.ImageMode, g.MarketPrice, g.OtherImagePath, g.BrandTpID, g.PackTpID, g.DelegationTpID, g.ServiceTpID, g.ReportTpID, g.CustomContent, g.Visited, g.GoodsCommentNum, g.CategoryGlobalPathIds, g.AttributeValueIds, g.HelpMap, g.BrandID, g.ProfitPrice, g.CommissionPrice, g.Code, g.RecomputeProfit, g.RecomputeSaleplan, g.SellPrice, g.YSoldNum, g.Gid)
	}
	return err
}
...
// GoodsByBarCode retrieves a row from 'aypcddg.goods' as a Good.
//
// Generated from index 'bar_code'.
func GoodsByBarCode(ctx context.Context, barCode string, key ...interface{}) ([]*Good, error) {
	var err error
	var dbConn *sql.DB
	...
	// sql query
	sqlstr := `SELECT ` +
		`gid, pid, title, attribute_good_title, fid, fgid, sid, fbid, gcid, gcid_first, fcid, status, status_change_last_timestamp, factory_only, price_mode, price, plan_id, plan_id_status, plan_next_id, plan_next_time, plan_next_price, plan_next_id_status, prepay_price, can_cod, has_invoice, subtitle, content, packinfo, weight, volume, sku, product_code, bar_code, stock, stockday, unit, sold_num, list_pic_path, list_pic_picids, created, updated, plan_up_timestamp, plan_down_timestamp, seo_keyword, seo_description, fwid, ship_id, is_check, image_mode, market_price, other_image_path, brand_tp_id, pack_tp_id, delegation_tp_id, service_tp_id, report_tp_id, custom_content, visited, goods_comment_num, category_global_path_ids, attribute_value_ids, help_map, brand_id, profit_price, commission_price, code, recompute_profit, recompute_saleplan, sell_price, y_sold_num ` +
		`FROM ` + tableName +
		` WHERE bar_code = ?`

	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, barCode)))
	...
	if tx != nil {
		queryData, err = tx.Query(sqlstr, barCode)
		if err != nil {
			return nil, err
		}
	} else {
		queryData, err = dbConn.Query(sqlstr, barCode)
		if err != nil {
			return nil, err
		}
	}
	...
	for queryData.Next() {
		...
		// scan
		err = queryData.Scan(&g.Gid, &g.Pid, &g.Title, &g.AttributeGoodTitle, &g.Fid, &g.Fgid, &g.Sid, &g.Fbid, &g.Gcid, &g.GcidFirst, &g.Fcid, &g.Status, &g.StatusChangeLastTimestamp, &g.FactoryOnly, &g.PriceMode, &g.Price, &g.PlanID, &g.PlanIDStatus, &g.PlanNextID, &g.PlanNextTime, &g.PlanNextPrice, &g.PlanNextIDStatus, &g.PrepayPrice, &g.CanCod, &g.HasInvoice, &g.Subtitle, &g.Content, &g.Packinfo, &g.Weight, &g.Volume, &g.Sku, &g.ProductCode, &g.BarCode, &g.Stock, &g.Stockday, &g.Unit, &g.SoldNum, &g.ListPicPath, &g.ListPicPicids, &g.Created, &g.Updated, &g.PlanUpTimestamp, &g.PlanDownTimestamp, &g.SeoKeyword, &g.SeoDescription, &g.Fwid, &g.ShipID, &g.IsCheck, &g.ImageMode, &g.MarketPrice, &g.OtherImagePath, &g.BrandTpID, &g.PackTpID, &g.DelegationTpID, &g.ServiceTpID, &g.ReportTpID, &g.CustomContent, &g.Visited, &g.GoodsCommentNum, &g.CategoryGlobalPathIds, &g.AttributeValueIds, &g.HelpMap, &g.BrandID, &g.ProfitPrice, &g.CommissionPrice, &g.Code, &g.RecomputeProfit, &g.RecomputeSaleplan, &g.SellPrice, &g.YSoldNum)
		if err != nil {
			return nil, err
		}
...
// GoodsByBrandID retrieves a row from 'aypcddg.goods' as a Good.
//
// Generated from index 'brand_id'.
func GoodsByBrandID(ctx context.Context, brandID int, key ...interface{}) ([]*Good, error) {
	var err error
	var dbConn *sql.DB
...
// GoodsByCode retrieves a row from 'aypcddg.goods' as a Good.
//
// Generated from index 'code_index'.
func GoodsByCode(ctx context.Context, code int, key ...interface{}) ([]*Good, error) {
	var err error
	var dbConn *sql.DB
...
// GoodsByFbid retrieves a row from 'aypcddg.goods' as a Good.
//
// Generated from index 'fbid'.
func GoodsByFbid(ctx context.Context, fbid uint, key ...interface{}) ([]*Good, error) {
	var err error
	var dbConn *sql.DB
	...
	var queryData *sql.Rows
	if tx != nil {
		queryData, err = tx.Query(sqlstr, fbid)
		if err != nil {
			return nil, err
		}
	} else {
		queryData, err = dbConn.Query(sqlstr, fbid)
		if err != nil {
			return nil, err
		}
	}
...
// GoodsByGcidFirst retrieves a row from 'aypcddg.goods' as a Good.
//
// Generated from index 'gcid_first'.
func GoodsByGcidFirst(ctx context.Context, gcidFirst uint, key ...interface{}) ([]*Good, error) {
	var err error
	var dbConn *sql.DB
...
func GoodByGid(ctx context.Context, gid uint64, key ...interface{}) (*Good, error) {
	...
	if tx != nil {
		err = tx.QueryRow(sqlstr, gid).Scan(&g.Gid, &g.Pid, &g.Title, &g.AttributeGoodTitle, &g.Fid, &g.Fgid, &g.Sid, &g.Fbid, &g.Gcid, &g.GcidFirst, &g.Fcid, &g.Status, &g.StatusChangeLastTimestamp, &g.FactoryOnly, &g.PriceMode, &g.Price, &g.PlanID, &g.PlanIDStatus, &g.PlanNextID, &g.PlanNextTime, &g.PlanNextPrice, &g.PlanNextIDStatus, &g.PrepayPrice, &g.CanCod, &g.HasInvoice, &g.Subtitle, &g.Content, &g.Packinfo, &g.Weight, &g.Volume, &g.Sku, &g.ProductCode, &g.BarCode, &g.Stock, &g.Stockday, &g.Unit, &g.SoldNum, &g.ListPicPath, &g.ListPicPicids, &g.Created, &g.Updated, &g.PlanUpTimestamp, &g.PlanDownTimestamp, &g.SeoKeyword, &g.SeoDescription, &g.Fwid, &g.ShipID, &g.IsCheck, &g.ImageMode, &g.MarketPrice, &g.OtherImagePath, &g.BrandTpID, &g.PackTpID, &g.DelegationTpID, &g.ServiceTpID, &g.ReportTpID, &g.CustomContent, &g.Visited, &g.GoodsCommentNum, &g.CategoryGlobalPathIds, &g.AttributeValueIds, &g.HelpMap, &g.BrandID, &g.ProfitPrice, &g.CommissionPrice, &g.Code, &g.RecomputeProfit, &g.RecomputeSaleplan, &g.SellPrice, &g.YSoldNum)
		if err != nil {
			return nil, err
		}
	} else {
		err = dbConn.QueryRow(sqlstr, gid).Scan(&g.Gid, &g.Pid, &g.Title, &g.AttributeGoodTitle, &g.Fid, &g.Fgid, &g.Sid, &g.Fbid, &g.Gcid, &g.GcidFirst, &g.Fcid, &g.Status, &g.StatusChangeLastTimestamp, &g.FactoryOnly, &g.PriceMode, &g.Price, &g.PlanID, &g.PlanIDStatus, &g.PlanNextID, &g.PlanNextTime, &g.PlanNextPrice, &g.PlanNextIDStatus, &g.PrepayPrice, &g.CanCod, &g.HasInvoice, &g.Subtitle, &g.Content, &g.Packinfo, &g.Weight, &g.Volume, &g.Sku, &g.ProductCode, &g.BarCode, &g.Stock, &g.Stockday, &g.Unit, &g.SoldNum, &g.ListPicPath, &g.ListPicPicids, &g.Created, &g.Updated, &g.PlanUpTimestamp, &g.PlanDownTimestamp, &g.SeoKeyword, &g.SeoDescription, &g.Fwid, &g.ShipID, &g.IsCheck, &g.ImageMode, &g.MarketPrice, &g.OtherImagePath, &g.BrandTpID, &g.PackTpID, &g.DelegationTpID, &g.ServiceTpID, &g.ReportTpID, &g.CustomContent, &g.Visited, &g.GoodsCommentNum, &g.CategoryGlobalPathIds, &g.AttributeValueIds, &g.HelpMap, &g.BrandID, &g.ProfitPrice, &g.CommissionPrice, &g.Code, &g.RecomputeProfit, &g.RecomputeSaleplan, &g.SellPrice, &g.YSoldNum)
		if err != nil {
			return nil, err
		}
	}
...
// GoodsByStock retrieves a row from 'aypcddg.goods' as a Good.
//
// Generated from index 'goods_stock_index'.
func GoodsByStock(ctx context.Context, stock uint, key ...interface{}) ([]*Good, error) {
	var err error
	var dbConn *sql.DB
	...
	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, stock)))
	...
	var queryData *sql.Rows
	if tx != nil {
		queryData, err = tx.Query(sqlstr, stock)
		if err != nil {
			return nil, err
		}
	} else {
		queryData, err = dbConn.Query(sqlstr, stock)
		if err != nil {
			return nil, err
		}
	}
...
// GoodsByPlanIDStatus retrieves a row from 'aypcddg.goods' as a Good.
//
// Generated from index 'plan_id_status_index'.
func GoodsByPlanIDStatus(ctx context.Context, planIDStatus int8, key ...interface{}) ([]*Good, error) {
	var err error
	var dbConn *sql.DB
	...
	sqlstr := `SELECT ` +
		`gid, pid, title, attribute_good_title, fid, fgid, sid, fbid, gcid, gcid_first, fcid, status, status_change_last_timestamp, factory_only, price_mode, price, plan_id, plan_id_status, plan_next_id, plan_next_time, plan_next_price, plan_next_id_status, prepay_price, can_cod, has_invoice, subtitle, content, packinfo, weight, volume, sku, product_code, bar_code, stock, stockday, unit, sold_num, list_pic_path, list_pic_picids, created, updated, plan_up_timestamp, plan_down_timestamp, seo_keyword, seo_description, fwid, ship_id, is_check, image_mode, market_price, other_image_path, brand_tp_id, pack_tp_id, delegation_tp_id, service_tp_id, report_tp_id, custom_content, visited, goods_comment_num, category_global_path_ids, attribute_value_ids, help_map, brand_id, profit_price, commission_price, code, recompute_profit, recompute_saleplan, sell_price, y_sold_num ` +
		`FROM ` + tableName +
		` WHERE plan_id_status = ?`

	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, planIDStatus)))
	...
	var queryData *sql.Rows
	if tx != nil {
		queryData, err = tx.Query(sqlstr, planIDStatus)
		if err != nil {
			return nil, err
		}
	} else {
		queryData, err = dbConn.Query(sqlstr, planIDStatus)
		if err != nil {
			return nil, err
		}
	}
...
// GoodsByPrice retrieves a row from 'aypcddg.goods' as a Good.
//
// Generated from index 'price_index'.
func GoodsByPrice(ctx context.Context, price float64, key ...interface{}) ([]*Good, error) {
	var err error
	var dbConn *sql.DB
...
// GoodsByProductCode retrieves a row from 'aypcddg.goods' as a Good.
//
// Generated from index 'product_code'.
func GoodsByProductCode(ctx context.Context, productCode string, key ...interface{}) ([]*Good, error) {
	var err error
	var dbConn *sql.DB
	...
	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, productCode)))
	...
	var queryData *sql.Rows
	if tx != nil {
		queryData, err = tx.Query(sqlstr, productCode)
		if err != nil {
			return nil, err
		}
	} else {
		queryData, err = dbConn.Query(sqlstr, productCode)
		if err != nil {
			return nil, err
		}
	}
...
// GoodsBySellPrice retrieves a row from 'aypcddg.goods' as a Good.
//
// Generated from index 'sell_price_index'.
func GoodsBySellPrice(ctx context.Context, sellPrice float64, key ...interface{}) ([]*Good, error) {
	var err error
	var dbConn *sql.DB
	...
	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, sellPrice)))
	...
	var queryData *sql.Rows
	if tx != nil {
		queryData, err = tx.Query(sqlstr, sellPrice)
		if err != nil {
			return nil, err
		}
	} else {
		queryData, err = dbConn.Query(sqlstr, sellPrice)
		if err != nil {
			return nil, err
		}
	}
...
// GoodsByTitle retrieves a row from 'aypcddg.goods' as a Good.
//
// Generated from index 'title_index'.
func GoodsByTitle(ctx context.Context, title sql.NullString, key ...interface{}) ([]*Good, error) {
	var err error
	var dbConn *sql.DB
