...
type SaleplanGood struct {
	...
	PlanStatus      int            `json:"plan_status"`       // plan_status
	PlanType        int8           `json:"plan_type"`         // plan_type
	PriceType       uint           `json:"price_type"`        // price_type
	PricePercent    uint           `json:"price_percent"`     // price_percent
	PlanWeights     uint           `json:"plan_weights"`      // plan_weights
	...
	ActivityUseSort sql.NullInt64  `json:"activity_use_sort"` // activity_use_sort
...
func GetSaleplanGoodTableName(key ...interface{}) (string, error) {
	tableName, err := components.M.GetTable(components.E.Opts.DBConfig.Name, "saleplan_goods", key...)
	if err != nil {
		return "", err
	}
...
func (sg *SaleplanGood) Insert(ctx context.Context, key ...interface{}) error {
	...
	sqlstr := `INSERT INTO ` + tableName +
		` (` +
		`gid, pid, plan_id, plan_status, plan_type, price_type, price_percent, plan_weights, plan_start_time, plan_end_time, price, stock, limit_stock, stock_type, sold_num, status, good_status, platform_lock, created_at, updated_at, activity_use_sort` +
		`) VALUES (` +
		`?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?` +
		`)`

	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, sg.Gid, sg.Pid, sg.PlanID, sg.PlanStatus, sg.PlanType, sg.PriceType, sg.PricePercent, sg.PlanWeights, sg.PlanStartTime, sg.PlanEndTime, sg.Price, sg.Stock, sg.LimitStock, sg.StockType, sg.SoldNum, sg.Status, sg.GoodStatus, sg.PlatformLock, sg.CreatedAt, sg.UpdatedAt, sg.ActivityUseSort)))
	if err != nil {
		return err
	}
	if tx != nil {
		res, err = tx.Exec(sqlstr, sg.Gid, sg.Pid, sg.PlanID, sg.PlanStatus, sg.PlanType, sg.PriceType, sg.PricePercent, sg.PlanWeights, sg.PlanStartTime, sg.PlanEndTime, sg.Price, sg.Stock, sg.LimitStock, sg.StockType, sg.SoldNum, sg.Status, sg.GoodStatus, sg.PlatformLock, sg.CreatedAt, sg.UpdatedAt, sg.ActivityUseSort)
	} else {
		res, err = dbConn.Exec(sqlstr, sg.Gid, sg.Pid, sg.PlanID, sg.PlanStatus, sg.PlanType, sg.PriceType, sg.PricePercent, sg.PlanWeights, sg.PlanStartTime, sg.PlanEndTime, sg.Price, sg.Stock, sg.LimitStock, sg.StockType, sg.SoldNum, sg.Status, sg.GoodStatus, sg.PlatformLock, sg.CreatedAt, sg.UpdatedAt, sg.ActivityUseSort)
	}
...
func (sg *SaleplanGood) Update(ctx context.Context, key ...interface{}) error {
	...
	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, sg.Gid, sg.Pid, sg.PlanID, sg.PlanStatus, sg.PlanType, sg.PriceType, sg.PricePercent, sg.PlanWeights, sg.PlanStartTime, sg.PlanEndTime, sg.Price, sg.Stock, sg.LimitStock, sg.StockType, sg.SoldNum, sg.Status, sg.GoodStatus, sg.PlatformLock, sg.CreatedAt, sg.UpdatedAt, sg.ActivityUseSort, sg.ID)))
	if tx != nil {
		_, err = tx.Exec(sqlstr, sg.Gid, sg.Pid, sg.PlanID, sg.PlanStatus, sg.PlanType, sg.PriceType, sg.PricePercent, sg.PlanWeights, sg.PlanStartTime, sg.PlanEndTime, sg.Price, sg.Stock, sg.LimitStock, sg.StockType, sg.SoldNum, sg.Status, sg.GoodStatus, sg.PlatformLock, sg.CreatedAt, sg.UpdatedAt, sg.ActivityUseSort, sg.ID)
	} else {
		_, err = dbConn.Exec(sqlstr, sg.Gid, sg.Pid, sg.PlanID, sg.PlanStatus, sg.PlanType, sg.PriceType, sg.PricePercent, sg.PlanWeights, sg.PlanStartTime, sg.PlanEndTime, sg.Price, sg.Stock, sg.LimitStock, sg.StockType, sg.SoldNum, sg.Status, sg.GoodStatus, sg.PlatformLock, sg.CreatedAt, sg.UpdatedAt, sg.ActivityUseSort, sg.ID)
	}
	return err
}
...
func SaleplanGoodByPlanIDGid(ctx context.Context, planID int, gid int, key ...interface{}) (*SaleplanGood, error) {
	...
	// sql query
	sqlstr := `SELECT ` +
		`id, gid, pid, plan_id, plan_status, plan_type, price_type, price_percent, plan_weights, plan_start_time, plan_end_time, price, stock, limit_stock, stock_type, sold_num, status, good_status, platform_lock, created_at, updated_at, activity_use_sort ` +
		`FROM ` + tableName +
	...
	if tx != nil {
		err = tx.QueryRow(sqlstr, planID, gid).Scan(&sg.ID, &sg.Gid, &sg.Pid, &sg.PlanID, &sg.PlanStatus, &sg.PlanType, &sg.PriceType, &sg.PricePercent, &sg.PlanWeights, &sg.PlanStartTime, &sg.PlanEndTime, &sg.Price, &sg.Stock, &sg.LimitStock, &sg.StockType, &sg.SoldNum, &sg.Status, &sg.GoodStatus, &sg.PlatformLock, &sg.CreatedAt, &sg.UpdatedAt, &sg.ActivityUseSort)
		if err != nil {
			return nil, err
		}
	} else {
		err = dbConn.QueryRow(sqlstr, planID, gid).Scan(&sg.ID, &sg.Gid, &sg.Pid, &sg.PlanID, &sg.PlanStatus, &sg.PlanType, &sg.PriceType, &sg.PricePercent, &sg.PlanWeights, &sg.PlanStartTime, &sg.PlanEndTime, &sg.Price, &sg.Stock, &sg.LimitStock, &sg.StockType, &sg.SoldNum, &sg.Status, &sg.GoodStatus, &sg.PlatformLock, &sg.CreatedAt, &sg.UpdatedAt, &sg.ActivityUseSort)
		if err != nil {
			return nil, err
		}
	}
...
// SaleplanGoodsByPlanStatus retrieves a row from 'aypcddg.saleplan_goods' as a SaleplanGood.
//
// Generated from index 'plan_status'.
func SaleplanGoodsByPlanStatus(ctx context.Context, planStatus int, key ...interface{}) ([]*SaleplanGood, error) {
	var err error
	var dbConn *sql.DB
	...
	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, planStatus)))
	...
	if tx != nil {
		queryData, err = tx.Query(sqlstr, planStatus)
		if err != nil {
			return nil, err
		}
	} else {
		queryData, err = dbConn.Query(sqlstr, planStatus)
		if err != nil {
			return nil, err
		}
	}
	...
	for queryData.Next() {
		...
		// scan
		err = queryData.Scan(&sg.ID, &sg.Gid, &sg.Pid, &sg.PlanID, &sg.PlanStatus, &sg.PlanType, &sg.PriceType, &sg.PricePercent, &sg.PlanWeights, &sg.PlanStartTime, &sg.PlanEndTime, &sg.Price, &sg.Stock, &sg.LimitStock, &sg.StockType, &sg.SoldNum, &sg.Status, &sg.GoodStatus, &sg.PlatformLock, &sg.CreatedAt, &sg.UpdatedAt, &sg.ActivityUseSort)
		if err != nil {
			return nil, err
		}
...
// SaleplanGoodsByPlanWeights retrieves a row from 'aypcddg.saleplan_goods' as a SaleplanGood.
//
// Generated from index 'plan_weights'.
func SaleplanGoodsByPlanWeights(ctx context.Context, planWeights uint, key ...interface{}) ([]*SaleplanGood, error) {
	var err error
	var dbConn *sql.DB
	...
	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, planWeights)))
	...
	var queryData *sql.Rows
	if tx != nil {
		queryData, err = tx.Query(sqlstr, planWeights)
		if err != nil {
			return nil, err
		}
	} else {
		queryData, err = dbConn.Query(sqlstr, planWeights)
		if err != nil {
			return nil, err
		}
	}
...
// SaleplanGoodsByPriceType retrieves a row from 'aypcddg.saleplan_goods' as a SaleplanGood.
//
// Generated from index 'price_type'.
func SaleplanGoodsByPriceType(ctx context.Context, priceType uint, key ...interface{}) ([]*SaleplanGood, error) {
	var err error
	var dbConn *sql.DB
	...
	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, priceType)))
	...
	var queryData *sql.Rows
	if tx != nil {
		queryData, err = tx.Query(sqlstr, priceType)
		if err != nil {
			return nil, err
		}
	} else {
		queryData, err = dbConn.Query(sqlstr, priceType)
		if err != nil {
			return nil, err
		}
	}
...
func SaleplanGoodByID(ctx context.Context, id uint64, key ...interface{}) (*SaleplanGood, error) {
	...
	if tx != nil {
		err = tx.QueryRow(sqlstr, id).Scan(&sg.ID, &sg.Gid, &sg.Pid, &sg.PlanID, &sg.PlanStatus, &sg.PlanType, &sg.PriceType, &sg.PricePercent, &sg.PlanWeights, &sg.PlanStartTime, &sg.PlanEndTime, &sg.Price, &sg.Stock, &sg.LimitStock, &sg.StockType, &sg.SoldNum, &sg.Status, &sg.GoodStatus, &sg.PlatformLock, &sg.CreatedAt, &sg.UpdatedAt, &sg.ActivityUseSort)
		if err != nil {
			return nil, err
		}
	} else {
		err = dbConn.QueryRow(sqlstr, id).Scan(&sg.ID, &sg.Gid, &sg.Pid, &sg.PlanID, &sg.PlanStatus, &sg.PlanType, &sg.PriceType, &sg.PricePercent, &sg.PlanWeights, &sg.PlanStartTime, &sg.PlanEndTime, &sg.Price, &sg.Stock, &sg.LimitStock, &sg.StockType, &sg.SoldNum, &sg.Status, &sg.GoodStatus, &sg.PlatformLock, &sg.CreatedAt, &sg.UpdatedAt, &sg.ActivityUseSort)
		if err != nil {
			return nil, err
		}
	}
