...
type Order struct {
	...
	UserLevelSeq        sql.NullInt64   `json:"user_level_seq"`        // user_level_seq
	OrderFrom           sql.NullInt64   `json:"order_from"`            // order_from
	CollectionStatus    sql.NullInt64   `json:"collection_status"`     // collection_status
	OriginShipping      sql.NullFloat64 `json:"origin_shipping"`       // origin_shipping
	PlatformDiscountFee sql.NullFloat64 `json:"platform_discount_fee"` // platform_discount_fee
	...
	Fuid                sql.NullInt64   `json:"fuid"`                  // fuid
...
func GetOrderTableName(key ...interface{}) (string, error) {
	tableName, err := components.M.GetTable(components.E.Opts.DBConfig.Name, "orders", key...)
	if err != nil {
		return "", err
	}
...
func (o *Order) Update(ctx context.Context, key ...interface{}) error {
	...
	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, o.Q, o.UID, o.Name, o.Mobile, o.Email, o.Fid, o.Sid, o.Status, o.StatusExt, o.Created, o.PayTime, o.ShipTime, o.TotalFee, o.NeedFee, o.SettlementPaid, o.TotalPaid, o.PayMethod, o.Shipping, o.GoodsFee, o.DiscountFee, o.LogisticType, o.Pid, o.Cid, o.Aid, o.Address, o.AddressInfo, o.InvoiceInfo, o.Slinfo, o.Commission, o.Prepay, o.AffirmTime, o.NoteSale, o.NoteUser, o.RefundFee, o.SettlementStatus, o.SettlementTime, o.FromSite, o.FinishTime, o.BuyUserID, o.ActivityID, o.OrderNo, o.Shareid, o.FromUID, o.UserAddressID, o.GoodsOriginFee, o.UserLevelSeq, o.OrderFrom, o.CollectionStatus, o.OriginShipping, o.PlatformDiscountFee, o.ShopID, o.ShareUID, o.ProportionJSON, o.Fuid, o.UserProfitPrice, o.Orderid)))
	if tx != nil {
