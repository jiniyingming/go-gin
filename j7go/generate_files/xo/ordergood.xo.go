...
type OrderGood struct {
	...
	UserProfitPrice   sql.NullFloat64 `json:"user_profit_price"`   // user_profit_price
...
func GetOrderGoodTableName(key ...interface{}) (string, error) {
	tableName, err := components.M.GetTable(components.E.Opts.DBConfig.Name, "order_goods", key...)
	if err != nil {
		return "", err
	}
...
func (og *OrderGood) Insert(ctx context.Context, key ...interface{}) error {
	...
	sqlstr := `INSERT INTO ` + tableName +
		` (` +
		`orderid, pid, gid, title, allprice, prepay_price, price, number, shipping, goods_updated, comment, uid, refund_nums, next, note_user, stock_id, shareid, from_uid, activity_id, goods_origin_fee, real_settlement_fee, refund_fee, user_profit_price` +
		`) VALUES (` +
		`?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?` +
		`)`

	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, og.Orderid, og.Pid, og.Gid, og.Title, og.Allprice, og.PrepayPrice, og.Price, og.Number, og.Shipping, og.GoodsUpdated, og.Comment, og.UID, og.RefundNums, og.Next, og.NoteUser, og.StockID, og.Shareid, og.FromUID, og.ActivityID, og.GoodsOriginFee, og.RealSettlementFee, og.RefundFee, og.UserProfitPrice)))
	if err != nil {
		return err
	}
	if tx != nil {
		res, err = tx.Exec(sqlstr, og.Orderid, og.Pid, og.Gid, og.Title, og.Allprice, og.PrepayPrice, og.Price, og.Number, og.Shipping, og.GoodsUpdated, og.Comment, og.UID, og.RefundNums, og.Next, og.NoteUser, og.StockID, og.Shareid, og.FromUID, og.ActivityID, og.GoodsOriginFee, og.RealSettlementFee, og.RefundFee, og.UserProfitPrice)
	} else {
		res, err = dbConn.Exec(sqlstr, og.Orderid, og.Pid, og.Gid, og.Title, og.Allprice, og.PrepayPrice, og.Price, og.Number, og.Shipping, og.GoodsUpdated, og.Comment, og.UID, og.RefundNums, og.Next, og.NoteUser, og.StockID, og.Shareid, og.FromUID, og.ActivityID, og.GoodsOriginFee, og.RealSettlementFee, og.RefundFee, og.UserProfitPrice)
	}
...
func (og *OrderGood) Update(ctx context.Context, key ...interface{}) error {
	...
	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, og.Orderid, og.Pid, og.Gid, og.Title, og.Allprice, og.PrepayPrice, og.Price, og.Number, og.Shipping, og.GoodsUpdated, og.Comment, og.UID, og.RefundNums, og.Next, og.NoteUser, og.StockID, og.Shareid, og.FromUID, og.ActivityID, og.GoodsOriginFee, og.RealSettlementFee, og.RefundFee, og.UserProfitPrice, og.OrderGid)))
	if tx != nil {
		_, err = tx.Exec(sqlstr, og.Orderid, og.Pid, og.Gid, og.Title, og.Allprice, og.PrepayPrice, og.Price, og.Number, og.Shipping, og.GoodsUpdated, og.Comment, og.UID, og.RefundNums, og.Next, og.NoteUser, og.StockID, og.Shareid, og.FromUID, og.ActivityID, og.GoodsOriginFee, og.RealSettlementFee, og.RefundFee, og.UserProfitPrice, og.OrderGid)
	} else {
		_, err = dbConn.Exec(sqlstr, og.Orderid, og.Pid, og.Gid, og.Title, og.Allprice, og.PrepayPrice, og.Price, og.Number, og.Shipping, og.GoodsUpdated, og.Comment, og.UID, og.RefundNums, og.Next, og.NoteUser, og.StockID, og.Shareid, og.FromUID, og.ActivityID, og.GoodsOriginFee, og.RealSettlementFee, og.RefundFee, og.UserProfitPrice, og.OrderGid)
	}
	return err
}
...
func OrderGoodByOrderGid(ctx context.Context, orderGid int, key ...interface{}) (*OrderGood, error) {
	...
	// sql query
	sqlstr := `SELECT ` +
		`order_gid, orderid, pid, gid, title, allprice, prepay_price, price, number, shipping, goods_updated, comment, uid, refund_nums, next, note_user, stock_id, shareid, from_uid, activity_id, goods_origin_fee, real_settlement_fee, refund_fee, user_profit_price ` +
		`FROM ` + tableName +
		` WHERE order_gid = ?`
...
func OrderGoodsByOrderidGid(ctx context.Context, orderid int, gid int, key ...interface{}) ([]*OrderGood, error) {
	...
	for queryData.Next() {
		...
		// scan
		err = queryData.Scan(&og.OrderGid, &og.Orderid, &og.Pid, &og.Gid, &og.Title, &og.Allprice, &og.PrepayPrice, &og.Price, &og.Number, &og.Shipping, &og.GoodsUpdated, &og.Comment, &og.UID, &og.RefundNums, &og.Next, &og.NoteUser, &og.StockID, &og.Shareid, &og.FromUID, &og.ActivityID, &og.GoodsOriginFee, &og.RealSettlementFee, &og.RefundFee, &og.UserProfitPrice)
		if err != nil {
			return nil, err
		}
