...
func GetUserTableName(key ...interface{}) (string, error) {
	tableName, err := components.M.GetTable(components.E.Opts.DBConfig.Name, "users", key...)
	if err != nil {
		return "", err
	}
...
func (u *User) Insert(ctx context.Context, key ...interface{}) error {
	...
	sqlstr := `INSERT INTO ` + tableName +
		` (` +
		`username, email, mobile, encrypted_password, validate_status, created, updated, last_login, is_reg_user, identity, trace_code, mid_admin_id, mid_admin_name, created_at, updated_at, status, type` +
		`) VALUES (` +
		`?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?` +
		`)`

	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, u.Username, u.Email, u.Mobile, u.EncryptedPassword, u.ValidateStatus, u.Created, u.Updated, u.LastLogin, u.IsRegUser, u.Identity, u.TraceCode, u.MidAdminID, u.MidAdminName, u.CreatedAt, u.UpdatedAt, u.Status, u.Type)))
	if err != nil {
		return err
	}
	if tx != nil {
		res, err = tx.Exec(sqlstr, u.Username, u.Email, u.Mobile, u.EncryptedPassword, u.ValidateStatus, u.Created, u.Updated, u.LastLogin, u.IsRegUser, u.Identity, u.TraceCode, u.MidAdminID, u.MidAdminName, u.CreatedAt, u.UpdatedAt, u.Status, u.Type)
	} else {
		res, err = dbConn.Exec(sqlstr, u.Username, u.Email, u.Mobile, u.EncryptedPassword, u.ValidateStatus, u.Created, u.Updated, u.LastLogin, u.IsRegUser, u.Identity, u.TraceCode, u.MidAdminID, u.MidAdminName, u.CreatedAt, u.UpdatedAt, u.Status, u.Type)
	}
...
func (u *User) Update(ctx context.Context, key ...interface{}) error {
	...
	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, u.Username, u.Email, u.Mobile, u.EncryptedPassword, u.ValidateStatus, u.Created, u.Updated, u.LastLogin, u.IsRegUser, u.Identity, u.TraceCode, u.MidAdminID, u.MidAdminName, u.CreatedAt, u.UpdatedAt, u.Status, u.Type, u.UID)))
	if tx != nil {
		_, err = tx.Exec(sqlstr, u.Username, u.Email, u.Mobile, u.EncryptedPassword, u.ValidateStatus, u.Created, u.Updated, u.LastLogin, u.IsRegUser, u.Identity, u.TraceCode, u.MidAdminID, u.MidAdminName, u.CreatedAt, u.UpdatedAt, u.Status, u.Type, u.UID)
	} else {
		_, err = dbConn.Exec(sqlstr, u.Username, u.Email, u.Mobile, u.EncryptedPassword, u.ValidateStatus, u.Created, u.Updated, u.LastLogin, u.IsRegUser, u.Identity, u.TraceCode, u.MidAdminID, u.MidAdminName, u.CreatedAt, u.UpdatedAt, u.Status, u.Type, u.UID)
	}
	return err
}
...
func UsersByCreated(ctx context.Context, created uint, key ...interface{}) ([]*User, error) {
	...
	// sql query
	sqlstr := `SELECT ` +
		`uid, username, email, mobile, encrypted_password, validate_status, created, updated, last_login, is_reg_user, identity, trace_code, mid_admin_id, mid_admin_name, created_at, updated_at, status, type ` +
		`FROM ` + tableName +
		` WHERE created = ?`
	...
	for queryData.Next() {
		...
		// scan
		err = queryData.Scan(&u.UID, &u.Username, &u.Email, &u.Mobile, &u.EncryptedPassword, &u.ValidateStatus, &u.Created, &u.Updated, &u.LastLogin, &u.IsRegUser, &u.Identity, &u.TraceCode, &u.MidAdminID, &u.MidAdminName, &u.CreatedAt, &u.UpdatedAt, &u.Status, &u.Type)
		if err != nil {
			return nil, err
		}
...
// UsersByType retrieves a row from 'aypcddg.users' as a User.
//
// Generated from index 'type'.
func UsersByType(ctx context.Context, typ bool, key ...interface{}) ([]*User, error) {
	var err error
	var dbConn *sql.DB
...
func UserByUID(ctx context.Context, uid uint, key ...interface{}) (*User, error) {
	...
	if tx != nil {
		err = tx.QueryRow(sqlstr, uid).Scan(&u.UID, &u.Username, &u.Email, &u.Mobile, &u.EncryptedPassword, &u.ValidateStatus, &u.Created, &u.Updated, &u.LastLogin, &u.IsRegUser, &u.Identity, &u.TraceCode, &u.MidAdminID, &u.MidAdminName, &u.CreatedAt, &u.UpdatedAt, &u.Status, &u.Type)
		if err != nil {
			return nil, err
		}
	} else {
		err = dbConn.QueryRow(sqlstr, uid).Scan(&u.UID, &u.Username, &u.Email, &u.Mobile, &u.EncryptedPassword, &u.ValidateStatus, &u.Created, &u.Updated, &u.LastLogin, &u.IsRegUser, &u.Identity, &u.TraceCode, &u.MidAdminID, &u.MidAdminName, &u.CreatedAt, &u.UpdatedAt, &u.Status, &u.Type)
		if err != nil {
			return nil, err
		}
	}
