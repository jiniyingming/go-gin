...
type OrderGoodsSubRelation struct {
	...
	AfterServiceRemark sql.NullString `json:"after_service_remark"` // after_service_remark
...
func GetOrderGoodsSubRelationTableName(key ...interface{}) (string, error) {
	tableName, err := components.M.GetTable(components.E.Opts.DBConfig.Name, "order_goods_sub_relation", key...)
	if err != nil {
		return "", err
	}
...
func (ogsr *OrderGoodsSubRelation) Insert(ctx context.Context, key ...interface{}) error {
	...
	sqlstr := `INSERT INTO ` + tableName +
		` (` +
		`order_gid, orderid, gid, number, remark, created_at, updated_at, uid, activity_id, after_service_remark` +
		`) VALUES (` +
		`?, ?, ?, ?, ?, ?, ?, ?, ?, ?` +
		`)`

	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, ogsr.OrderGid, ogsr.Orderid, ogsr.Gid, ogsr.Number, ogsr.Remark, ogsr.CreatedAt, ogsr.UpdatedAt, ogsr.UID, ogsr.ActivityID, ogsr.AfterServiceRemark)))
	if err != nil {
		return err
	}
	if tx != nil {
		res, err = tx.Exec(sqlstr, ogsr.OrderGid, ogsr.Orderid, ogsr.Gid, ogsr.Number, ogsr.Remark, ogsr.CreatedAt, ogsr.UpdatedAt, ogsr.UID, ogsr.ActivityID, ogsr.AfterServiceRemark)
	} else {
		res, err = dbConn.Exec(sqlstr, ogsr.OrderGid, ogsr.Orderid, ogsr.Gid, ogsr.Number, ogsr.Remark, ogsr.CreatedAt, ogsr.UpdatedAt, ogsr.UID, ogsr.ActivityID, ogsr.AfterServiceRemark)
	}
...
func (ogsr *OrderGoodsSubRelation) Update(ctx context.Context, key ...interface{}) error {
	...
	// run query
	utils.GetTraceLog(ctx).Debug("DB", zap.String("SQL", fmt.Sprint(sqlstr, ogsr.OrderGid, ogsr.Orderid, ogsr.Gid, ogsr.Number, ogsr.Remark, ogsr.CreatedAt, ogsr.UpdatedAt, ogsr.UID, ogsr.ActivityID, ogsr.AfterServiceRemark, ogsr.OrderGsrid)))
	if tx != nil {
		_, err = tx.Exec(sqlstr, ogsr.OrderGid, ogsr.Orderid, ogsr.Gid, ogsr.Number, ogsr.Remark, ogsr.CreatedAt, ogsr.UpdatedAt, ogsr.UID, ogsr.ActivityID, ogsr.AfterServiceRemark, ogsr.OrderGsrid)
	} else {
		_, err = dbConn.Exec(sqlstr, ogsr.OrderGid, ogsr.Orderid, ogsr.Gid, ogsr.Number, ogsr.Remark, ogsr.CreatedAt, ogsr.UpdatedAt, ogsr.UID, ogsr.ActivityID, ogsr.AfterServiceRemark, ogsr.OrderGsrid)
	}
	return err
}
...
func OrderGoodsSubRelationByOrderGsrid(ctx context.Context, orderGsrid uint64, key ...interface{}) (*OrderGoodsSubRelation, error) {
	...
	// sql query
	sqlstr := `SELECT ` +
		`order_gsrid, order_gid, orderid, gid, number, remark, created_at, updated_at, uid, activity_id, after_service_remark ` +
		`FROM ` + tableName +
		` WHERE order_gsrid = ?`
	...
	if tx != nil {
		err = tx.QueryRow(sqlstr, orderGsrid).Scan(&ogsr.OrderGsrid, &ogsr.OrderGid, &ogsr.Orderid, &ogsr.Gid, &ogsr.Number, &ogsr.Remark, &ogsr.CreatedAt, &ogsr.UpdatedAt, &ogsr.UID, &ogsr.ActivityID, &ogsr.AfterServiceRemark)
		if err != nil {
			return nil, err
		}
	} else {
		err = dbConn.QueryRow(sqlstr, orderGsrid).Scan(&ogsr.OrderGsrid, &ogsr.OrderGid, &ogsr.Orderid, &ogsr.Gid, &ogsr.Number, &ogsr.Remark, &ogsr.CreatedAt, &ogsr.UpdatedAt, &ogsr.UID, &ogsr.ActivityID, &ogsr.AfterServiceRemark)
		if err != nil {
			return nil, err
		}
	}
